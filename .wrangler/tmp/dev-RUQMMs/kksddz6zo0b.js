// .wrangler/tmp/bundle-xhoPmO/checked-fetch.js
...
// .wrangler/tmp/pages-GPAsSU/bundledWorker-0.04906546486129448.mjs
...
var ie = (e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of re(t))
      !ne.call(e, n) && n !== r && j(e, n, { get: () => t[n], enumerable: !(s = se(t, n)) || s.enumerable });
  return e;
};
var O = (e, t, r) => (r = e != null ? te(ae(e)) : {}, ie(t || !e || !e.__esModule ? j(r, "default", { value: e, enumerable: true }) : r, e));
var y;
var l = k(() => {
  y = { collectedLocales: [] };
});
...
function Z() {
  globalThis.fetch[J] || (ye(), globalThis.fetch[J] = true);
}
function ye() {
...
var C = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return x(this.searchParams, H.searchParams), S(this.path) || (this.path = H.pathname), n;
  }
...
var ns = { async fetch(e, t, r) {
  ...
  return n.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: w }, async () => i.run({ env: t, ctx: r, cf: e.cf }, async () => {
    ...
    let o = D(e);
    return Y({ request: o, ctx: r, assetsFetcher: t.ASSETS }, f, m, y);
  }));
} };
...
// .wrangler/tmp/pages-GPAsSU/kksddz6zo0b.js
...
// .wrangler/tmp/bundle-xhoPmO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xhoPmO/middleware-loader.entry.ts
